...
time_start = time()
#________e______________________________________________________________________________________________________________________________________________________________
global run
#main loop
run = True
for j in [2000 + 20*(z+1) for z in range(25)]:
    i = 0
    added_score = 0
    number_of_found_life = 0
    number_of_found_water = 0
    ...
    print()
    results.append(added_map/number_of_simulations)

print("ACABOUUUUUUUUUUUUUUUUUU")
print(len(results))
print()
